...
#include <memory>
#include "../../header/customField/customLineEdit.h"
...
QT_MOC_LITERAL(1, 15, 22), // "onPasswordJudgeClicked"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 18), // "onControllerEdited"
QT_MOC_LITERAL(4, 58, 3) // "arg"

    },
    "customLineEdit\0onPasswordJudgeClicked\0"
    "\0onControllerEdited\0arg"
};
...
void customLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onPasswordJudgeClicked(); break;
        case 1: _t->onControllerEdited((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject customLineEdit::staticMetaObject = { {
    QMetaObject::SuperData::link<AbstractCustomField::staticMetaObject>(),
...
void *customLineEdit::qt_metacast(const char *_clname)
{
    ...
    return AbstractCustomField::qt_metacast(_clname);
}

int customLineEdit::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AbstractCustomField::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
