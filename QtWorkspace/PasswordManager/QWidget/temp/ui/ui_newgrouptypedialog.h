/********************************************************************************
** Form generated from reading UI file 'newgrouptypedialog.ui'
**
...
#ifndef UI_NEWGROUPTYPEDIALOG_H
#define UI_NEWGROUPTYPEDIALOG_H
...
public:
    ...
    void setupUi(QDialog *newGroupTypeDialog)
    {
        if (newGroupTypeDialog->objectName().isEmpty())
            newGroupTypeDialog->setObjectName(QString::fromUtf8("newGroupTypeDialog"));
        newGroupTypeDialog->resize(890, 700);
        newGroupTypeDialog->setMinimumSize(QSize(890, 700));
        newGroupTypeDialog->setMaximumSize(QSize(890, 700));
        tabWidget = new QTabWidget(newGroupTypeDialog);
        ...
        describe = new QTextEdit(essentialInfo);
        describe->setObjectName(QString::fromUtf8("describe"));
        describe->setGeometry(QRect(330, 30, 481, 41));
        tabWidget->addTab(editType, QString());
        frame = new QFrame(newGroupTypeDialog);
...
"border-radius:10px;"));
    ...
    void retranslateUi(QDialog *newGroupTypeDialog)
    {
        newGroupTypeDialog->setWindowTitle(QCoreApplication::translate("newGroupTypeDialog", "Dialog", nullptr));
        editTypeButton->setText(QCoreApplication::translate("newGroupTypeDialog", "\347\274\226\350\276\221\347\261\273\345\236\213", nullptr));
        deleteTypeButton->setText(QCoreApplication::translate("newGroupTypeDialog", "\345\210\240\351\231\244\347\261\273\345\236\213", nullptr));
        copyTypeButton->setText(QCoreApplication::translate("newGroupTypeDialog", "\345\244\215\345\210\266\347\261\273\345\236\213", nullptr));
        newTypeButton->setText(QCoreApplication::translate("newGroupTypeDialog", "\346\226\260\345\273\272\347\261\273\345\236\213", nullptr));
        chosenLabel->setText(QCoreApplication::translate("newGroupTypeDialog", "\345\275\223\345\211\215\351\200\211\344\270\255\347\261\273\345\236\213", nullptr));
        chosen->setText(QCoreApplication::translate("newGroupTypeDialog", "\346\234\252\351\200\211\344\270\255", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(typeManager), QCoreApplication::translate("newGroupTypeDialog", "\347\261\273\345\236\213\347\256\241\347\220\206", nullptr));
        editFields->setTitle(QCoreApplication::translate("newGroupTypeDialog", "\347\274\226\350\276\221\345\255\227\346\256\265", nullptr));
        addFieldLabel->setText(QCoreApplication::translate("newGroupTypeDialog", "\345\255\227\346\256\265\347\261\273\345\236\213", nullptr));
        addFieldButton->setText(QCoreApplication::translate("newGroupTypeDialog", "\346\267\273\345\212\240\345\255\227\346\256\265", nullptr));
        confirm->setText(QCoreApplication::translate("newGroupTypeDialog", "\347\241\256\345\256\232", nullptr));
        cancel->setText(QCoreApplication::translate("newGroupTypeDialog", "\345\217\226\346\266\210", nullptr));
        essentialInfo->setTitle(QCoreApplication::translate("newGroupTypeDialog", "\345\237\272\346\234\254\344\277\241\346\201\257", nullptr));
        describe->setPlaceholderText(QCoreApplication::translate("newGroupTypeDialog", "\347\274\226\350\276\221\347\261\273\345\236\213\350\257\264\346\230\216", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(editType), QCoreApplication::translate("newGroupTypeDialog", "\347\274\226\350\276\221/\346\226\260\345\273\272\347\261\273\345\236\213", nullptr));
    } // retranslateUi

};

namespace Ui {
    class newGroupTypeDialog: public Ui_newGroupTypeDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_NEWGROUPTYPEDIALOG_H
